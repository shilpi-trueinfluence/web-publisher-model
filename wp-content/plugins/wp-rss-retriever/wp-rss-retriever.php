...
// Global variables
define('WP_RSS_RETRIEVER_VER', '1.5.5');
...
include( WP_RSS_RETRIEVER_PLUGIN_PATH . 'inc/lib/simplepie/autoloader.php');
...
function wp_rss_retriever_css_js() {
    ...
    wp_localize_script( 'rss-retriever-ajax', 'rss_retriever',
