		...
		<div class="ur-form-row">
			<div class="ur-form-grid">
					...
					<p class="form-row">
						...
						if ( 'yes' === $remember_me_enabled ) {
                                                    ...
                                                    <label class="user-registration-form__label user-registration-form__label-for-checkbox inline container-label">
                                                            <input class="user-registration-form__input user-registration-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" style="margin-top: 0;" /> <span><?php _e( 'Remember me', 'user-registration' ); ?></span>
					...
					?>
                                        ...
                                        <p style="text-align: center;font-size: 14px;color: #69717a;">By submitting this form, you agree to be bound by the <a href="#">Terms of Use</a> and <a href="#">Privacy Policy</a>.</p>
