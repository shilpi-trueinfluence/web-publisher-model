...
class CodelessAdsWidget extends WP_Widget{
    ...
    function __construct(){
		...
		parent::__construct( 'widget_ads', 'Specular Widget Ads', $options );
    ...
    function widget($atts, $instance){
        ...
        echo '<a href="'.esc_url($ad_url).'"><img style="'.$extra_style.'" src="'.esc_url($ad_img).'" alt="'.esc_attr__('Featured Image', 'codeless').'" /></a>';
